...
interface GroupDao {
    ...
    fun getGroupMembers(groupId: String): Flow<List<com.prabs.ceipts.data.local.entity.GroupMemberEntity>>

    @Query("SELECT * FROM group_members")
    fun getAllGroupMembers(): Flow<List<com.prabs.ceipts.data.local.entity.GroupMemberEntity>>

    @Insert(onConflict = OnConflictStrategy.REPLACE)
    suspend fun insertGroupMember(member: com.prabs.ceipts.data.local.entity.GroupMemberEntity)
}
